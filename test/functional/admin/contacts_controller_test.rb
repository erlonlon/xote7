...
class Admin::ContactsControllerTest < ActionController::TestCase
  ...
  test "should create admin_contact" do
    assert_difference('Admin::Contact.count') do
      post :create, admin_contact: { assunto: @admin_contact.assunto, cidade: @admin_contact.cidade, email: @admin_contact.email, mensagem: @admin_contact.mensagem, nome: @admin_contact.nome }
    end
  ...
  test "should update admin_contact" do
    put :update, id: @admin_contact, admin_contact: { assunto: @admin_contact.assunto, cidade: @admin_contact.cidade, email: @admin_contact.email, mensagem: @admin_contact.mensagem, nome: @admin_contact.nome }
    assert_redirected_to admin_contact_path(assigns(:admin_contact))
  end
