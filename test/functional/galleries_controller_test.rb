...
class GalleriesControllerTest < ActionController::TestCase
  ...
  test "should create gallery" do
    assert_difference('Gallery.count') do
      post :create, gallery: { album: @gallery.album, autor: @gallery.autor, descricao: @gallery.descricao, titulo: @gallery.titulo }
    end
  ...
  test "should update gallery" do
    put :update, id: @gallery, gallery: { album: @gallery.album, autor: @gallery.autor, descricao: @gallery.descricao, titulo: @gallery.titulo }
    assert_redirected_to gallery_path(assigns(:gallery))
  end
